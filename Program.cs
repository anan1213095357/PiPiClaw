  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .box{
      ...
      box-shadow:0 10px 30px rgba(0,0,0,.8), inset 0 0 20px rgba(0,242,254,.02);
      position:relative;
      overflow:hidden;
    ...
    .box:hover{box-shadow:0 10px 40px rgba(0,0,0,.9), inset 0 0 20px rgba(0,242,254,.05);}
    .box::before{
      content:"";
    ...
    .msg.user .msg-content{
      background:linear-gradient(135deg,rgba(0,242,254,.15),rgba(0,150,255,.05));
    ...
    .exec-terminal .log-action{color:#00eaff; font-weight:800; display:block; margin-bottom:4px;}
    .exec-terminal .log-result{color:#9aa4af; display:block; margin-bottom:10px; padding-left:8px; border-left:2px solid rgba(139,148,158,.3);}
